...
//		URL url = Adempiere.class.getResource("images/" + fileNameInImageDir);
	...
	{
		null,
		getImageIcon("mWindow.png"),
		getImageIcon("mReport.png"),
		getImageIcon("mProcess.png"),
		getImageIcon("mWorkFlow.png"),
		getImageIcon("mWorkbench.png"),
		getImageIcon("mSetVariable.png"),
		getImageIcon("mUserChoice.png"),
		getImageIcon("mDocAction.png")
	};
