...
@JsonIgnoreProperties( "taxes", "meta_data" )
data class LineItemsItem(@JsonProperty("quantity")
                         val quantity: Int = 0,
...
data class Billing(@JsonProperty("country")
                   val country: String = "",
                   @JsonProperty("city")
                   val city: String = "",
                   @JsonProperty("phone")
...
data class Shipping(@JsonProperty("country")
                    val country: String = "",
                    @JsonProperty("city")
                    val city: String = "",
                    @JsonProperty("address_1")
...
data class SelfItem(@JsonProperty("href")
                    val href: String = "")
