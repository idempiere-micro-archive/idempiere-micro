...
public class BaseActivator implements BundleActivator 
{
	...
	public void start(BundleContext context) throws Exception {
		...
		loadInitProperties(Ini.getIni().getAdempiereHome());
	...
	private void loadInitProperties(String filePath)  {
		...
		System.out.println( "loadInitProperties from " + filePath );
		...
		System.out.println( "loadOk = " + loadOk );
	}
