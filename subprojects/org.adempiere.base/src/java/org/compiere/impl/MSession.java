...
public class MSession extends X_AD_Session
{
	...
	/**	Sessions					*/
	private static CCache<Integer, MSession> s_sessions = Ini.getIni().isClient() 
	...
	public MSession (Properties ctx, String Remote_Addr, String Remote_Host, String WebSession, String trxName)
	{
		...
		setDescription(Adempiere.getI().MAIN_VERSION + "_"
				+ Adempiere.getI().DATE_VERSION + " "
				+ Adempiere.getI().getImplementationVersion());
