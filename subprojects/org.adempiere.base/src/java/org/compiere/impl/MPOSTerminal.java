...
public class MPOSTerminal extends X_U_POSTerminal
{
	...
	/** Cache                   */
    static private CCache<Integer,MPOSTerminal> s_cache = new CCache<Integer,MPOSTerminal>(I_U_POSTerminal.Table_Name, 10, 60);
    ...
    {
        if (is_ValueChanged(I_U_POSTerminal.COLUMNNAME_Locked) && isLocked())
        {
    ...
    /**
     * @see PO#afterSave(boolean, boolean)
     */
