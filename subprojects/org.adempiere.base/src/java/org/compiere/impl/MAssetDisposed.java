...
implements DocAction
{
	...
	public String completeIt()
	{
		...
		if(!isDisposal())
		{
			...
			{
				throw new AssetNotSupportedException(I_A_Asset_Disposed.COLUMNNAME_A_Activation_Method, method);
			}
		}
		...
		else
		{
			...
			{
				throw new AssetNotSupportedException(I_A_Asset_Disposed.COLUMNNAME_A_Disposed_Method, method);
			}
		}
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (newRecord || is_ValueChanged(I_A_Asset_Disposed.COLUMNNAME_DateAcct))
		{
